...
navlink: Now
---
This is my [Now-page](https://nownownow.com/about), inspired by [Derek Sivers](https://sive.rs/). Last updated on {{ page.date | date: '%e %B %Y' }}. Archive of previous Now-pages can be found [here]({{site.baseurl}}/then).
